...
def check_deployment_health():
    ...
    try:
        response = requests.get("https://email-parsing-three.vercel.app/health", timeout=10)
...
def main():
    ...
    if passed == total:
        ...
        print("2. Update Postmark webhook URL to: https://email-parsing-three.vercel.app/webhook")
        print("3. Test the pipeline by making a commit")
        print("4. Monitor the first workflow runs at: https://github.com/rakid/EmailParsing/actions")
        return 0
    else:
