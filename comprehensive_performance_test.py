...
def test_email_processing_performance():
    ...
    test_emails = [
        ...
        },
        {
            ...
            "email": EmailData(
                ...
                text_body="Please find attached the weekly report for review. Let me know if you have any questions.",
        ...
        },
        {
            ...
            "email": EmailData(
                ...
                text_body="This is a very large email with extensive content. " * 100,  # Large content
    ...
    print(f"✅ Single Email Performance Summary:")
    print(f"   Average processing time: {avg_time:.4f}s")
    print(f"   Maximum processing time: {max_time:.4f}s")
    print(f"   Target: < 2.0s per email")
...
def test_batch_processing_performance():
    ...
    for batch_size in batch_sizes:
        ...
        print(f"   Batch {batch_size}: {avg_time_per_email:.4f}s avg | {emails_per_second:.1f} emails/s | {status}")
...
def test_memory_usage():
    ...
    print(f"   Target: < 50 MB total increase")
...
def test_storage_performance():
    ...
    print(f"   Target: < 0.01s per operation")
...
def main():
    ...
    print("=" * 65)
    print(f"Target: All email processing operations < 2.0s")
    print(f"Memory target: < 50MB increase for 100 emails")
    print("=" * 65)
