...
class TestEmailExtractor:
    ...
    def test_extract_high_urgency_indicators(self, sample_email_data):
        ...
        assert any(
            "urgent" in indicator for indicator in metadata.urgency_indicators["high"]
        )
    ...
    def test_extract_low_urgency_indicators(self, sample_low_urgency_email):
        ...
        assert (
            len(metadata.urgency_indicators["high"]) == 0
            or len(metadata.urgency_indicators["low"]) > 0
        )
    ...
    def test_extract_action_words(self):
        ...
        text_with_actions = (
            "Please review the document and send me your feedback. Call the client."
        )
...
class TestEmailExtractionIntegration:
    ...
    def test_very_long_content(self):
        ...
        assert len(metadata.priority_keywords) > 0
