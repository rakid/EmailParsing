...
class EmailData(BaseModel):
    ...
    attachments: List[AttachmentData] = Field(default=[], description="Email attachments")
...
class EmailAnalysis(BaseModel):
    ...
    temporal_references: List[str] = Field(default=[], description="Date/time references found")
...
class ProcessedEmail(BaseModel):
    ...
    webhook_payload: Dict[str, Any] = Field(default={}, description="Original webhook data")
...
class EmailStats(BaseModel):
    ...
    processing_times: List[float] = Field(default=[], description="Processing time samples")
